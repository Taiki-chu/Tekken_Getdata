...
//					sb.append(xPath.evaluate("h:td["+1+"]", itemNode));
//					String value1;
//					if(sb.toString().indexOf("\n")!=-1) {value1=(sb.delete(sb.toString().indexOf("\n"), sb.length())).toString();}
...
//					String value41="";String value51="";
//					if(xPath.evaluate("h:td["+4+"]/h:span/h:span[@title]", itemNode).replace("\n", "").contains("D")) {
//						value41= xPath.evaluate("h:td["+4+"]/h:span/h:@title", itemNode).replace("\n", "");value4=value4+value41;
//					}
					String value5= xPath.evaluate("h:td["+5+"]", itemNode).replace("\n", "");
//					if(xPath.evaluate("h:td["+5+"]/h:span/h:span[@title]", itemNode).replace("\n", "").contains("D")) {
//						value51= xPath.evaluate("h:td["+5+"]/h:span/h:@title", itemNode).replace("\n", "");value5=value5+value51;
//					}
